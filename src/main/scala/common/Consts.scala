...
object Consts{ 
  ...
  val BUBBLE = 0x00000013.U(WORD_LEN.W) // [ADDI x 0, x 0, 0] = BUBBLE 
  val UNIMP = 0xc0001073L.U( WORD_LEN.W) // [CSRRW x 0, cycle, x 0] 
  val ADDR_LEN = 5 // rs 1, rs 2, wb 
  val CSR_ADDR_LEN = 12 
  val VLEN = 128
  val LMUL_LEN = 2 
  val SEW_LEN = 11 
  ...
  val ALU_MULHSU = 24.U(EXE_FUN_LEN.W) 
  val ALU_MULHU = 25.U(EXE_FUN_LEN.W)
  ...
  val WB_MUL = 7.U(WB_SEL_LEN.W)
  val WB_DIV = 8.U(WB_SEL_LEN.W)
